...
def start(update, context):
    ...
    context.bot.sendMessage(update.message.chat_id, 'Hi! I am Dragon\n(ᵔᴥᵔ)つ' )
...
def help(update, context):
    ...
    context.bot.sendMessage(update.message.chat_id, "/price - Get the latest coin price. ex: /price BTC,ETH...\n/stats - Get the latest coin stats. ex: /stats BTC,ETH...\n/news - Get the latest news. Optionally specify coin /news BTC,ETH...")
